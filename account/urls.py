...
urlpatterns = [
    ...
    path('user-permissions/delete/<int:user_permissions_id>', views.user_permissions_delete, name='user_permissions_delete'),
    ...
    path("collectors/delete/<int:collector_id>/", views.collector_delete, name="collector_delete"),
]